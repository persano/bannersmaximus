    ...
    c.fn.extend({
        ...
        smoothproducts: function() {
            ...
            c(".sp-loading").hide(), c(".sp-wrap").each(function() {
                ...
                }), c(".sp-large", this).append('<a href="' + a + '" class="sp-current-big"><img src="' + n + '" "' + c("img", this).attr("alt") + '" alt="" /></a>')) : (c(this).append('<div class="sp-large"></div>'), c("a", this).appendTo(c(".sp-large", this)).addClass(".sp-current-big")), c(".sp-wrap").css("display", "inline-block")
