        ...
        c(".sp-loading").hide(), c(".sp-wrap").each(function() {
          ...
          c(this).addClass("sp-touch"), 1 < c("a", this).length ? (i = !!c("a.sp-default", this)[0], c(this).append('<div class="sp-large"></div><div class="sp-thumbs sp-tb-active"></div>'), c("a", this).each(function(s) {
            var t = c("img", this).attr("src"),
              e = c(this).attr("href"),
              p = "";
            (0 === s && !i || c(this).hasClass("sp-default")) && (p = ' class="sp-current"', a = e, n = c("img", this)[0].src), j = c("img", this)[0].src),  c(this).parents(".sp-wrap").find(".sp-thumbs").append('<a href="' + e + '" style="background-image:url(' + t + ')"' + p + "></a>"), c(this).remove()
          }), c(".sp-large", this).append('<a href="' + a + '" class="sp-current-big"><img src="' + n + '" alt="' + altf + '" /></a>')) : (c(this).append('<div class="sp-large"></div>'), c("a", this).appendTo(c(".sp-large", this)).addClass(".sp-current-big")), c(".sp-wrap").css("display", "inline-block")
