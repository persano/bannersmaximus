	...
	$.fn.extend({
		...
		smoothproducts: function() {
			...
			$(document.body).on('mouseenter', '.sp-non-touch .sp-large', function(event) {
				var largeUrl1 = $('a', this).attr('href');
                var largeUrl = largeUrl1.replace('_800.jpg','.jpg');
			...
			$(document.body).on('click', '.sp-non-touch .sp-zoom', function(event) {
				var currentImg1 = $(this).html(),
                currentImg = currentImg1.replace('_800.jpg','.jpg'),
			...
			$(document.body).on('click', '.sp-large a', function(event) {
				var currentImg1 = $(this).attr('href'),
                currentImg = currentImg1.replace('_800.jpg','.jpg'),
					thumbAmt = $(this).parents('.sp-wrap').find('.sp-thumbs a').length,
					currentThumb = ($(this).parents('.sp-wrap').find('.sp-thumbs .sp-current').index())+1;
			...
			$(document.body).on('click', '#sp-next', function(event) {
				...
				var currentEq = $('.sp-lightbox').data('currenteq'),
					...
					if(currentEq >= totalItems) {
						...
						newImg1 = $('.sp-selected .sp-thumbs').find('a:eq('+currentEq+')').attr('href'),
                        newImg = newImg1.replace('_800.jpg','.jpg'),
			...
			$(document.body).on('click', '#sp-prev', function(event) {
				...
				var currentEq = $('.sp-lightbox').data('currenteq'),
					...
					if(currentEq <= 0) {
						...
						var nextEq = currentEq - 1,
						newImg1 = $('.sp-selected .sp-thumbs').find('a:eq('+nextEq+')').attr('href'),
                        newImg = newImg1.replace('_800.jpg','.jpg'),
